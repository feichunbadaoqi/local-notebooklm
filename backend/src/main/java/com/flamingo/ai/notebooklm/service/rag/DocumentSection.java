 ...
 *
 * <p>Sections are detected by {@link DocumentParser} implementations (e.g. via PDF font metrics or
 * XHTML heading tags) and form a tree that mirrors the document outline.
 *
